...
class BFSolver(Solver):
    ...
    def solve_kemeny(self, scenario):
        ...
        return [scenario.out_consistent[idx] for idx in idxs_max]
    ...
    def solve_maxham(self, scenario):
        ...
        idxs_max = [idx for idx,agr in enumerate(agr_mins) if agr == max(agr_mins)]
        return [scenario.out_consistent[idx] for idx in idxs_max]
    ...
    def solve_maxeq(self, scenario):
        ...
        idxs_min = [idx for idx,agr in enumerate(agr_maxDists) if agr == min(agr_maxDists)]
        return [scenario.out_consistent[idx] for idx in idxs_min]
    ...
    def solve_all(self, scenario, lamb):
        ...
        idxs_opts = [idxs_kem, idxs_kn, idxs_maxham, idxs_maxeq]
        outcomes = [[scenario.out_consistent[idx] for idx in idxs_opt] for idxs_opt in idxs_opts]
        return outcomes
